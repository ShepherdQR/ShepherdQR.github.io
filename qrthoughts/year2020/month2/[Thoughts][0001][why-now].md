...
status: "published"
source:
  path: "qrthoughts/year2020/month2/[Thoughts][0001][why-now].md"
  date_source:
    created: "markdown-comment"
    published: "index-data"
    updated: "markdown-comment"
---
# About the current life：It all starts here
Because of the varius, people have stayed at home for over a month. Need to recover to normal study life.
